    ...
    <div className="mx-auto flex flex-col w-full max-w-7xl px-4 py-2 text-sm">
      <section className="flex flex-wrap items-center gap-2">
        <div className="flex items-center gap-2">
          ...
          <div className="w-6 h-0 border border-grey-85 rotate-90"></div>
          <div className="font-inter font-normal text-18px leading-[22px] text-custom-black">
            Completed
          </div>
          <div className="font-inter font-normal text-18px leading-[22px] text-primary">
            In Review
          </div>
        </div>
        <div className="w-6 h-0 border border-grey-85 rotate-90 ml-[300px] "></div>
        <div className="flex items-center gap-1 ">
          ...
          <div className="flex items-center justify-start gap-2 w-[130px] h-[34px] border border-[#EBEBEB] rounded-[4px]">
            <div className="ml-2 font-inter font-medium text-[14px]  leading-[18px] text-[#6366F1]">All</div>
            <select className="ml-[70px] h-full rounded-md border-0 bg-transparent py-0 text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
              <option></option>
            </select>
          </div>
        </div>
        <div className="w-6 h-0 border border-grey-85 rotate-90"></div>
        <div className="flex items-center w-full sm:w-[412px] h-[40px] bg-[#F1F5F9] border-2 border-[#F1F5F9] rounded-full shadow-sm">
          ...
          <input
            ...
            name="search"
            id="search"
            className="flex-grow bg-[#F1F5F9] placeholder-gray-500 text-sm leading-8 font-inter font-normal focus:outline-none"
            placeholder="Search Bounties, Profiles, and more..."
          />
        </div>
      </section>

      <div className="my-2 w-full max-w-[900px] border border-gray-300"></div>

      <div className="flex flex-col mt-2 ml-3 max-w-[880px] h-[116px]">
        {data.map((c, i) => (
          <Card
            key={i}
            image={c.image}
